...
#! Note: this code oftenly gives error (some langchain abstractions issue), better use `InferenceClient` from huggingface module, that code is in another folder names `HuggingFace`
