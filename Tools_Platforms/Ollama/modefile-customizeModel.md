...
- `PARAMETER num_ctx 4096` → Sets the maximum number of tokens the model can handle. Means how many tokens the model can handle in one go this is also called as context length. Another name `PARAMETER context_length 4096` 
